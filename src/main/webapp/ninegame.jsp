...
<title>Insert title here</title>
		<link href="css2/mui.min.css" rel="stylesheet" />
		<link rel="stylesheet" href="css2/_9game.css" />
	</head>
		...
		<body>
			<div style="width: 700px; margin: 0 auto;">
				...
				<div>
					<div class="bcolor mui-row">
						...
						<div class="mui-col-xs-1" id="logo2">
							<a href="#"><img src="imgs2/icon_message.png" /></a>
						</div>
					</div>
				</div>
				...
				<div class="mui-slider">
					<div class="mui-slider-group mui-slider-loop">
						...
						<div class="mui-slider-item mui-slider-item-duplicate">
							<a href="#"><img src="imgs2/19392261.jpg" /></a>
						</div>
						<div class="mui-slider-item">
							<a href="#"><img src="imgs2/19369044.jpg" /></a>
						</div>
						<div class="mui-slider-item">
							<a href="#"><img src="imgs2/19392169.jpg" /></a>
						</div>
						<div class="mui-slider-item">
							<a href="#"><img src="imgs2/19392195.jpg" /></a>
						</div>
						<div class="mui-slider-item">
							<a href="#"><img src="imgs2/19392241.jpg" /></a>
						</div>
						<div class="mui-slider-item">
							<a href="#"><img src="imgs2/19392261.jpg" /></a>
						</div>
				...
				<div class="bcolor mui-row">
					...
					<div class="item">
						<a href="#"><img src="imgs2/18547785.png" /></a>
						<p align="center" class="font1">分类</p>
					</div>
					<div class="item">
						<a href="#"><img src="imgs2/18547781.png" /></a>
						<p align="center" class="font1">新游</p>
					</div>
					<div class="item">
						<a href="#"><img src="imgs2/18547782.png" /></a>
						<p align="center" class="font1">最热</p>
					</div>
					<div class="item">
						<a href="#"><img src="imgs2/18547783.png" /></a>
						<p align="center" class="font1">单机</p>
					</div>
					<div class="item">
						<a href="#"><img src="imgs2/18547784.png" /></a>
					...
					<div style="padding-top: 25px;" class="mui-row">
						...
						<div class="mui-col-sm-0">
							<a href="#">
								...
								<img src="imgs2/icon-right-black_82997b0.png" />
							</a>
						</div>
					</div>
					<!--游戏目录-->
					<div class="item2">
						<a href="#"><img class="imgsize" src="imgs2/19365949.png" /></a>
						<a href="#">
							<p class="font5">奇迹最强者</p>
						</a>
						<a href="#">
							<p class="font6">角色 419.4m</p>
						</a>
						<div class="float3">
							<p id="font4">下载</p>
						</div>
				...
				<div class="bcolor mui-row">
					<div style="padding-top: 25px;" class="mui-row">
						<div class="mui-col-sm-10">
							<h2 style="padding-left: 30px;">打法时间必备</h2>
						</div>
						<div class="mui-col-sm-0">
							<a href="#">
								<font size="5" color="#000000">更多</font>
				...
				<!--新游预约-->
					...
					<dl class="test1">
						<dt>
							<h2>分类精选</h2>
							<a href="#">更多<img src="imgs2/icon-right-black_82997b0.png"></a>
						</dt>
						<dd >
